...
class VADHead(DETRHead):
    ...
    def __init__(self,
        ...
        eeg_attn_module_layer = nn.TransformerDecoderLayer(256, self.eeg_heads, dim_feedforward=256*2, dropout=self.eeg_dropout, batch_first=False)
        ...
        self.brain_query_pos = torch.nn.Parameter(torch.randn(1, 1, 256))         
    ...
    def forward(self,
        ...
        brain_q_with_pos = ego_map_query + self.brain_query_pos
        brain_k_with_pos = brain_feats + self.brain_key_pos 
        brain_key = self.eeg_mlp(brain_k_with_pos)    
        ego_eeg_query = self.eeg_attn(brain_q_with_pos, brain_key)
