...
class PanopticMetric(Metric):
    ...
    def panoptic_metrics(self, pred_segmentation, pred_instance, gt_segmentation, gt_instance, unique_id_mapping):
        ...
        # print("pred_segmentation:",pred_segmentation.shape)
        # print("pred_instance:",pred_instance.shape)
        # print("gt_segmentation:",gt_segmentation.shape)
        # print("gt_instance:",gt_instance.shape)
        # print()
        pred_segmentation = pred_segmentation.view(gt_segmentation.shape)
        pred_instance = pred_instance.view(gt_instance.shape)
        # if pred_segmentation.dim()!=2:
