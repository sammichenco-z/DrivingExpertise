...
class UniAD(UniADTrack):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        config_path = "/data/43_server_pkg/wanghan/video_b2d_tf/Bench2DriveZoo_brain/mmcv/eeg_vedio/cfgs/video_encoder_inference.yaml"
        project_dir="/data/43_server_pkg/wanghan/video_b2d_tf/Bench2DriveZoo_brain/mmcv/eeg_vedio"
        with open(config_path, 'r') as f:
            config = yaml.safe_load(f)   
        config = config['video_encoder']
        config["ckpt_load_path"] = "/data/43_server_pkg/wanghan/eeg_ckpts/duration_1.5_fps_2_all_single_gpu_2/video_encoder_epoch_119.safetensors"
