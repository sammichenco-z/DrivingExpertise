...
model = dict(
    ...
    train_cfg=dict(pts=dict(
        ...
        assigner=dict(
            ...
            iou_cost=dict(type='IoUCost', weight=0), # Fake cost. This is just to make it compatible with DETR head.
            pc_range=point_cloud_range),
        map_assigner=dict(
            type='MapHungarianAssigner3D',
            cls_cost=dict(type='FocalLossCost', weight=0),
            reg_cost=dict(type='BBoxL1Cost', weight=0, box_format='xywh'),
