...
class VAD(MVXTwoStageDetector):
    ...
    def __init__(self,
        ...
        # ])  
        config_path = "/data/wanghan/tf_vad_indoor/projects/eeg_vedio/cfgs/video_encoder_inference.yaml"
        project_dir="/data/wanghan/tf_vad_indoor/projects/eeg_vedio"
        with open(config_path, 'r') as f:
            config = yaml.safe_load(f)   
        config = config['video_encoder']
        config["ckpt_load_path"] = "/data/wanghan/eeg-Jul8/outdoor-eeg_6+duration_2_fps_2+novice_+eeg_visual_spatial+debug_eeg_area+bs_16+epoch_120+lr_2e-5+dropout_0.01+weight_decay_1e-5+eeg_normalized+full_tuning+lr_ratio_1.safetensors"
