...
learning_rate_list=(5e-6 1e-5 2e-5 3e-5 5e-5 1e-4)
learning_rate_ratio_list=(0.2 0.1)
dropout=0.1
weight_decay=8e-5
...
for learning_rate_ratio in "${learning_rate_ratio_list[@]}"; do
    for learning_rate in "${learning_rate_list[@]}"; do
        ...
        extra_identifier="try_${debug_id}+dropout_${dropout}+weight_decay_${weight_decay}+lr_${learning_rate}+lr_ratio_${learning_rate_ratio}"
